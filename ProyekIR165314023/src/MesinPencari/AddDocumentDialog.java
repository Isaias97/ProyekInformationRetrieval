...
public class AddDocumentDialog extends javax.swing.JDialog {
     ...
     */
    public AddDocumentDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddDocumentDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddDocumentDialog dialog = new AddDocumentDialog(new javax.swing.JFrame(), true);
